...
export const LoginScreen = () => {
  ...
  const handleDownload = () => {
    const textContent =
      `GRAM JAL JEEVAN INTEGRATION REPORT\nGenerated: ${new Date().toLocaleString()}\n\n` +
  ...
  return (
    <div
      ...
      style={{ fontFamily: "'Noto Sans', 'Inter', 'Segoe UI', sans-serif" }}
    >
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-blue-900 via-blue-950 to-slate-900 p-10 flex flex-col justify-center relative overflow-hidden">
          <div className="relative z-10 flex flex-col items-center space-y-8">
            ...
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-6 border-l-4 border-amber-500 shadow-xl">
              <p
                className="text-white text-2xl font-black tracking-wide leading-tight uppercase"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Gram Jal Jeevan Mission
              </p>
              <p
                className="text-amber-400 text-sm font-bold mt-2 uppercase tracking-wider"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
          ...
          {!showRegistry ? (
            <>
              <div className="mb-8 flex items-start justify-between">
                <div>
                  <h2
                    className="text-3xl font-black text-blue-950 mb-1 uppercase tracking-wide"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    Welcome Back
                  </h2>
                  <p
                    className="text-black font-bold uppercase text-sm tracking-wider"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                ...
                <div className="w-40">
                  <label
                    className="block text-xs font-black text-blue-950 uppercase mb-1 flex items-center gap-1 tracking-widest"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  <label
                    className="block text-xs font-black text-blue-950 uppercase mb-2 tracking-widest"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    Select Role
                  </label>
                  ...
                  <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 space-y-2 animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="text-xs text-gray-600 border-t border-red-100 pt-2 mt-2">
                      <div className="font-semibold mb-1">
                        Trouble Logging in? Contact Ministry:
                      </div>
                      <div className="flex items-center gap-2">
                        <Phone size={12} /> Helpline: 1800-JAL-SHAKTI
                      </div>
                      <div className="flex items-center gap-2">
                        <Mail size={12} /> Support: help@jaljeevan.gov.in
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="mt-8 pt-6 border-t-2 border-gray-200">
                ...
                >
                  <File size={16} className="transition-transform group-hover:rotate-12" /> View
            ...
            <div className="animate-in fade-in slide-in-from-right-4 h-full flex flex-col">
              <div className="flex justify-between items-center mb-4">
                <h3
                  className="font-black text-blue-950 text-lg uppercase tracking-wide"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
              ...
              <div className="flex-1 overflow-y-auto border-2 rounded-xl bg-gray-50 p-2 space-y-2 mb-4">
                {integrations.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white p-4 rounded-lg border-2 border-gray-200 shadow-md flex justify-between items-center hover:shadow-xl transition-all duration-300 transform hover:scale-102 cursor-pointer"
                  >
                    <div>
