        ...
        <div className="flex items-center gap-3">
          {isLive && (
            <div
              ...
              style={{ backgroundColor: '#D1FAE5', borderRadius: 'var(--radius-sm)' }}
            >
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-6">
        ...
        >
          <p
            ...
            style={{ color: 'var(--gray-text)', marginBottom: '4px' }}
          >
            Total Valves
          </p>
        ...
        >
          <p className="text-[10px] md:text-lg" style={{ color: '#059669', marginBottom: '4px' }}>
            Open Valves
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4">
          {valves.map((valve) => (
            ...
            >
              ...
              {valve.state === 'OPEN' && (
                <div className="space-y-1 mb-2 md:mb-3">
                  <div className="flex justify-between items-center">
                    <span className="text-[9px] md:text-base" style={{ color: 'var(--gray-text)' }}>
                      Flow:
                    </span>
                    <span
                  ...
                  {valve.leakageProbability > 20 && (
                    <div
                      className="flex items-center gap-1 mt-1 p-1 md:p-2"
                      style={{ backgroundColor: '#FEF3C7', borderRadius: 'var(--radius-sm)' }}
                    >
                      <AlertTriangle
                        size={12}
              ...
              <div
                className="space-y-1 text-[9px] md:text-sm mb-2 md:mb-4"
                style={{ color: 'var(--gray-text)' }}
              >
