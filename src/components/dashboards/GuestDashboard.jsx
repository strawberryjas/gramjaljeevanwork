      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-5 border-b-4 border-blue-500 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
          ...
          <p className="text-3xl font-black text-black">
            2.5M <span className="text-xl text-gray-600">Liters</span>
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 border-b-4 border-green-500 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
          ...
          <p className="text-3xl font-black text-black">
            99.8<span className="text-xl text-gray-600">%</span>
          </p>
          <div className="w-full bg-gray-200 rounded-full h-2.5 mt-3">
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 border-b-4 border-red-500 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
          ...
          <p className="text-3xl font-black text-black">
            0 <span className="text-xl text-gray-600">Today</span>
          </p>
          <div className="w-full bg-gray-200 rounded-full h-2.5 mt-3">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-purple-500">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {achievements.map((achievement, index) => (
            <div
              key={index}
              className={`flex flex-col items-center p-4 rounded-lg shadow-md ${achievement.unlocked ? 'bg-gradient-to-br from-white to-gray-50 border border-gray-200' : 'bg-gray-100 border border-gray-300 opacity-70'}`}
            >
              <div
                className={`w-16 h-16 rounded-full flex items-center justify-center text-3xl mb-2 ${achievement.unlocked ? 'bg-white shadow-inner' : 'bg-gray-200'}`}
              >
                {achievement.icon}
              </div>
              <p
                className={`font-bold text-center ${achievement.unlocked ? 'text-black' : 'text-gray-600'}`}
              >
                {achievement.name}
              </p>
              <p className={`text-xs ${achievement.unlocked ? 'text-gray-600' : 'text-gray-500'}`}>
                {achievement.points} Points
              </p>
              {!achievement.unlocked && (
                <span className="text-xs text-red-500 font-bold mt-1">LOCKED</span>
              )}
            </div>
          ))}
        </div>
