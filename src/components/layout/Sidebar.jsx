    ...
    <>
      ...
      >
        ...
        <div className="h-16 border-b flex items-center justify-between px-4">
          {!collapsed && <h2 className="font-bold text-lg text-gray-900">Navigation</h2>}
          <button
          ...
          <button onClick={onToggle} className="lg:hidden p-2 hover:bg-gray-100 rounded-lg">
            <X size={20} />
          </button>
        </div>
                ...
                <div key={index} className="space-y-1">
                  ...
                  {item.items.map((subItem) => (
                    ...
                    >
                      ...
                      {!collapsed && <span className="font-medium text-sm">{subItem.label}</span>}
                    </button>
                  ))}
                </div>
              );
