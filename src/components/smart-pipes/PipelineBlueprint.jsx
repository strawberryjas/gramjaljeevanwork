    ...
    <g className="group cursor-pointer">
      <defs>
        ...
        <linearGradient id={gradId} x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <stop offset="100%" stopColor={isLeaking ? '#ef4444' : '#3b82f6'} /> {/* Outlet Red if leak */}
        </linearGradient>
      </defs>
      ...
      <g transform={`translate(${x1}, ${y1})`}>
        ...
        <text y="-15" textAnchor="middle" className="text-[10px] fill-slate-500 font-mono font-bold tracking-tighter">
          IN
        </text>
      </g>
      ...
      {/* 6. TECHNICAL TOOLTIP */}
      <foreignObject x={(x1 + x2) / 2 - 100} y={(y1 + y2) / 2 + 10} width="200" height="100" className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
        <div className="bg-slate-900/90 backdrop-blur-md text-slate-100 text-xs p-3 rounded-md shadow-2xl border border-slate-700">
          <div className="flex justify-between items-center border-b border-slate-700 pb-1 mb-2">
            ...
            <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold ${isLeaking ? 'bg-red-500/20 text-red-400' : 'bg-blue-500/20 text-blue-400'}`}>
          ...
          <div className="grid grid-cols-2 gap-y-1 gap-x-4 font-mono text-[10px]">
            ...
            <span className={`text-right font-bold ${lossAmount > 0.5 ? 'text-amber-400' : 'text-slate-400'}`}>
      ...
      <svg width="100%" height="100%" viewBox="0 0 800 400" className="w-full h-full">
        <defs>
          ...
          <pattern id="blueprintGrid" width="40" height="40" patternUnits="userSpaceOnUse">
            ...
            <path d="M 10 0 L 10 40 M 20 0 L 20 40 M 30 0 L 30 40 M 0 10 L 40 10 M 0 20 L 40 20 M 0 30 L 40 30" fill="none" stroke="#1e293b" strokeWidth="0.5" opacity="0.3" />
          </pattern>
        ...
        <g transform="translate(30, 180)">
          ...
          <g>
            {/* Left Pillar */}
            <rect x="5" y="10" width="4" height="30" rx="1"
              fill="url(#pillarGrad)" stroke="#44403c" strokeWidth="1.5"
              filter="url(#dropShadow)" />
            {/* Pillar Reinforcement Rings */}
            <rect x="4" y="15" width="6" height="1.5" fill="#57534e" stroke="#292524" strokeWidth="0.5" />
            <rect x="4" y="32" width="6" height="1.5" fill="#57534e" stroke="#292524" strokeWidth="0.5" />

            {/* Right Pillar */}
            <rect x="31" y="10" width="4" height="30" rx="1"
              fill="url(#pillarGrad)" stroke="#44403c" strokeWidth="1.5"
              filter="url(#dropShadow)" />
            {/* Pillar Reinforcement Rings */}
            <rect x="30" y="15" width="6" height="1.5" fill="#57534e" stroke="#292524" strokeWidth="0.5" />
            <rect x="30" y="32" width="6" height="1.5" fill="#57534e" stroke="#292524" strokeWidth="0.5" />
          ...
          <g transform="translate(-5, -10)">
            {/* Tank Main Body */}
            <rect x="0" y="0" width="50" height="40" rx="4"
              fill="url(#tankGrad)" stroke="#44403c" strokeWidth="2"
              filter="url(#dropShadow)" />

            {/* Metallic Reinforcement Bands */}
            <rect x="0" y="8" width="50" height="2" fill="#57534e" stroke="#292524" strokeWidth="0.5" opacity="0.8" />
            <rect x="0" y="20" width="50" height="2" fill="#57534e" stroke="#292524" strokeWidth="0.5" opacity="0.8" />
            <rect x="0" y="32" width="50" height="2" fill="#57534e" stroke="#292524" strokeWidth="0.5" opacity="0.8" />
            ...
            {/* Tank Top Cap */}
            <ellipse cx="25" cy="0" rx="25" ry="4" fill="#44403c" stroke="#292524" strokeWidth="1" />
            ...
            <g clipPath="url(#tankClip)">
              ...
              <path d="M 2 12 Q 14 10 26 12 T 48 12" fill="none" stroke="#60a5fa" strokeWidth="1" opacity="0.5" />
            </g>

            {/* Level Gauge (External) */}
            <rect x="-2" y="8" width="2" height="28" rx="1" fill="#475569" stroke="#1e293b" strokeWidth="0.5" />
          ...
          {/* Label */}
          <text x="20" y="-15" textAnchor="middle" className="text-[10px] fill-slate-500 font-mono font-bold">MAIN TANK</text>
