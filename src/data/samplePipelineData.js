  ...
  features: [
    ...
    },
    {
      ...
      properties: {
        ...
        status: 'critical',
        alert:
          'Pressure dropped below threshold. Possible leak detected in Ward 3 distribution line.',
